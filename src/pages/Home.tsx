...
function App() {
  return (
    <>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-4 w-full">
          ...
          <div className="flex flex-col gap-4 md:basis-1/2">
            ...
            <p className="text-xs lg:text-base">
              ...
              navigate your path to Singaporean citizenship with professionalism
              and expertise.
            </p>
            <p className="text-sm lg:text-base font-bold">
              <u>Find out more</u>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-4 w-full">
          ...
          <div className="flex flex-col gap-4 md:basis-1/2">
            ...
            <p className="text-xs lg:text-base">
              ...
              disappointment rejection brings, and our dedicated team is
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full lg:px-6">
